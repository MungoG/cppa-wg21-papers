...
### 2.8 Zero-cost ignore and diagnostic quality
...
The library part is a header. The `assertion_control` concept, `default_control`, the branch table, and the worked control objects of Section 2.7 are ordinary library code. The header also provides the plain-function surface of P4009R0<sup>[3]</sup> over the same machinery for the contexts that prefer it.
