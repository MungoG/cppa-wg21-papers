...
| 12. Static analysis | An analyzer that consumes P2900 contract specifiers, which the cited prototype states as a future hope<sup>[67]</sup>; or a recorded decision with reasons that the syntax-level argument suffices for C++26. | 2 or 3 |
