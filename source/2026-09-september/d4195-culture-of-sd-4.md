...
The minority may believe: "The technical problem is still there. Nothing about a poll made it disappear." The reactions are predictable and documented. Some<!-- W16: author to specify --> withdraw: "Fine. Do whatever you want." Some<!-- W16: author to specify --> become more forceful: "You still have not answered the objection." Some<!-- W16: author to specify --> start documenting everything. Some<!-- W16: author to specify --> produce competing papers. Some<!-- W16: author to specify --> appeal to another subgroup or national body. Some<!-- W16: author to specify --> become suspicious of the institution itself. A vicious feedback loop develops: the minority feels unheard, the minority becomes more forceful, the majority perceives obstruction, the majority discounts the minority, the minority feels even less heard.
...
**The majority will often<!-- W16: author to specify --> still be friendly to the minority personally. But the procedural outcome gradually substitutes for a technical verdict: the position lost the poll, so the position must have been wrong.**
...
The game becomes a war of attrition: who is willing to pay the cost for longer? Persistence changes the probability of winning independently of technical quality. Showing up again is itself a move. A skilled author will often<!-- W16: author to specify --> withdraw, revise, negotiate, or postpone rather than demand "A or B. Vote now." The losing design may not receive a dramatic rejection. It may experience: less agenda time, then no forwarding poll, then another revision requested, then the champion loses interest, then nothing. B simply stopped moving.
...
\]
<!-- W16: author to specify "many" in equation above -->
