...
| 2025-11 | EWG Kona: seven NB removal comments all fail (~9 SF vs ~40 SA each), tallies on the EWG [wiki](https://wiki.isocpp.org/2025-11_Kona:EWGContractsRemovalAndNonRemoval); [N5031](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2025/n5031.pdf)<sup>[5]</sup> records "Rejected all but 2 requests" | POLL |
