...
The variable they are unconsciously optimizing is \( \Pr(\text{consensus}) \): survivability through the represented veto structure.<!-- dcp: NB. Does this edit successfully represent the intended meaning?--> That distinction is the whole game.
...
[55] [P3911R2](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2026/p3911r2.html) - "RO 2-056 6.11.2 [basic.contract.eval] Make Contracts Reliably Non-Ignorable" (Darius Nea&tcedil;u, Andrei Alexandrescu, Lucian Radu Teodorescu, Radu Nichita, Herb Sutter, 2026). The tally is quoted in section 1.2 of the proponents' own paper; the primary record is the members-only NB ballot tracker.

[56] [cplusplus/papers issue 2641](https://github.com/cplusplus/papers/issues/2641#issuecomment-4018920377) - EWG telecon poll record for D4005R1, posted by the EWG vice-chair, 2026-03-08.
...
| 2025-11 | EWG Kona: D3911 non-ignorable pre! (SF:18, F:25, N:22, A:7, SA:0) - consensus for change<sup>[55]</sup> | POLL |
...
| 2026-02 | EWG telecon: D4005R1 not consensus;<sup>[56]</sup> D4009R1 strong consensus against<sup>[57]</sup> | POLL |
...
- The Wroclaw forward (November 2024) was followed by P3506/P3573 opposition, which was met by P3591/P3500/P2899 rebuttals arriving for Hagenberg (February 2025) where the removal poll failed and plenary adopted. Note: P2899, a comprehensive rationale paper, was filed January 13 - one day after P3573 was filed on January 12. The filing sequence means the record reads it as responsive, and the record is wrong. P2900R7 named "[P2899R0], 'Contracts for C++ - Rationale'" as its companion paper on 2024-05-22, 235 days before P3573R0, and the reference is absent from P2900R4, R5 and R6.<sup>[53]</sup> P2899R0 dates the track itself to the Kona poll of November 2022, and P3573 appears nowhere in its 160 pages.<sup>[16]</sup> Its own authors name a different paper as the answer: P2899R1 records that "A comprehensive response to all these concerns was published in [P3591R0]."<sup>[54]</sup><sup>[10]</sup>
...
- The Kona "pursue D3911" opening (November 2025) was immediately met by P3912/P3946 rebuttals in December 2025, arriving before the EWG telecon series that ran in January and February 2026. The January telecons polled P3911; the February telecon is where D4005R1 and D4009R1 both failed.<sup>[56]</sup><sup>[57]</sup>
