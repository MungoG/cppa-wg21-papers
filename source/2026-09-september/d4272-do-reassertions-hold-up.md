...
The SG21 chair's own position must be stated here, because it cuts toward this paper's author. John Spicer chaired SG21 from its 2019 chartering<sup>[98]</sup> through the Hagenberg adoption,<sup>[99]</sup> and he is a coauthor of three of the five objecting papers P3846R1 answers (P3835R0, P3829R0, and P3878R0),<sup>[3]</sup><sup>[4]</sup><sup>[7]</sup> of the hardening change adopted at Kona,<sup>[77]</sup> and of P4238R0 with the present author.<sup>[93]</sup> Two consequences follow, and this paper accepts both. First, the finding of Table 3 is not suspended for SG21. The subgroup's polls of record are tallies with an outcome label,<sup>[26]</sup><sup>[91]</sup> and no finding in words, no named sustainer, and no communication to an author is recorded beside any of them, under a chair who held the poll-taking discretion SD-4 grants.<sup>[70]</sup> An objecting paper is an objection, not a reconciliation record, and the chair's papers are recorded here as the former. Second, the record does not relocate the duty. The dispositions P3846R1's Discussion Status fields invoke are, in the main, EWG polls at Wroc&lstrok;aw and Hagenberg and the Hagenberg plenary vote; SG21 decisions are invoked in a minority of the fields, among them Concerns 8, 9, 10, and 16, and the two objections this paper records as Answered are among those. The sustained opposition the proposers' rationale names arose in EWG after the subgroup forwarded the design, and the five objecting papers and the national body comments were addressed to EWG, to plenary, and to the ballot, not to SG21. A subgroup chair cannot reconcile objections lodged in a forum he does not chair, and SD-4 places both the appointment of that chair and the determination of plenary consensus with the convener.<sup>[70]</sup> The duty this section locates is the duty to answer the sixteen objections where they were raised. Where SG21's own record is short in the same rows, that shortfall is charged to the same chain, and this paper does not exempt its author's coauthor from it.
